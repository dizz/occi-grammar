...
// !!!! This is an old grammar and not accurate compared to occi-antlr-grammar !!!!
// !!!! However it demonstrates taking the OCCI format and converting it to a  !!!!
...
@members{
  public static occi_http_textParser getParser(String occiHeader) throws Exception {
